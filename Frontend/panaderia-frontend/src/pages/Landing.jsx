          ...
          <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8">
            {productos.map((producto, i) => (
              ...
              >
                ...
                {/* Contenido */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-[#5D4037] mb-2 group-hover:text-amber-700 transition-colors">
                    {producto.nombre}
                  </h3>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      {producto.tiene_oferta && producto.oferta_activa ? (
                        <div>
                          <p className="text-sm text-gray-500 line-through">₡{producto.precio}</p>
                          <p className="text-2xl font-bold text-red-600">
                            ₡{producto.oferta_activa.precio_oferta}
                          </p>
                        </div>
                      ) : (
                        <p className="text-2xl font-bold text-amber-700">₡{producto.precio}</p>
                      )}
                    </div>
                    
                    <button 
                      onClick={() => handleAddToCart(producto)}
                      className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white p-3 rounded-xl transition-all hover:scale-110 shadow-lg"
                    >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div {...fadeUp(0.2)} className="bg-white rounded-2xl p-8 shadow-lg text-center hover:shadow-xl transition-all border-2 border-transparent hover:border-amber-200">
              ...
              <p className="text-[#8D6E63]">+506 2222-3333</p>
            </motion.div>
