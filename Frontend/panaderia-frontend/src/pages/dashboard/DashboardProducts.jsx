// Frontend/panaderia-frontend/src/pages/dashboard/DashboardProducts.jsx
...
import { FaShoppingCart, FaSearch, FaExclamationCircle, FaBox, FaStore } from "react-icons/fa"; // ⭐ AGREGAR FaStore
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === "todos"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === "disponibles"
                  ? "bg-amber-600 text-white"
                  : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === "agotados"
                  ? "bg-amber-600 text-white"
                  : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                }`}
            >
          ...
          {filteredProducts.map((product, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border-2 group relative ${estaAgotado ? 'border-red-300 opacity-75' : 'border-gray-100'
                  }`}
              >
                {/* Badge de Agotado */}
                {estaAgotado && (
                ...
                <div
                  ...
                  className={`h-48 overflow-hidden bg-gray-100 relative cursor-pointer hover:opacity-90 transition-opacity ${estaAgotado ? 'opacity-60' : ''
                    }`}
                >
                  <img
                    src={
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-medium shadow-md ${estaAgotado
