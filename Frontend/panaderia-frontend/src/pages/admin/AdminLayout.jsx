// Frontend/panaderia-frontend/src/pages/admin/AdminLayout.jsx
...
export default function AdminLayout() {
  ...
  useEffect(() => {
    ...
    setUser(userData);
    console.log('🔒 Admin Regular Layout - Usuario:', userData);
  }, []);
  ...
  // ⭐ Menú SOLO para Admin Regular (sin "Usuarios")
  const menuItems = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-200">Administrador</p>
                </div>
              </div>
      ...
      >
        ...
        <div className="p-8">
          ...
          <Outlet context={{ selectedBranch: user?.sucursal_id }} />
        </div>
      </div>
    </div>
  );
